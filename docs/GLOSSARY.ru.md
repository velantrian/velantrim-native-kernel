...
|---|---|---|
| **Claim** | Неизменяемое семантическое утверждение или наблюдение со стабильной identity и полями provenance. | Claim не становится автоматически истинным, актуальным, авторизованным или свободным от конфликта. |
