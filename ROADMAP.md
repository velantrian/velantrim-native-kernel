...
> [!IMPORTANT]
> **Current authoritative overlay — 2026-08-15; acquisition routing corrected 2026-09-06.** Resolve live `main` through GitHub. Current selected family: `A10-H11`; current gate: `A10_H11_EXECUTION_ADMISSION`; admission: `BLOCKED_NO_QUALIFYING_INDEPENDENT_REVIEWER_REPRODUCER`; qualifying reviewer/reproducer: `NOT_ESTABLISHED`; H11: `NOT_TESTED`; open review surface: Issue #178 (PR #131 is a merged historical predecessor artifact). H11 implementation/execution, dependency-graph execution, and semantic adjudication are `NOT AUTHORIZED`. Runtime expansion remains `FROZEN`; product runtime thaw `false`; Final Canon `DEFERRED / NOT_AUTHORIZED`; production `false`; Issue #88 remains OPEN. The roadmap does not own live HEAD; GitHub does. Historical D6/D8/ADR-0027/RAVP checkpoints below are provenance, not current gates.
